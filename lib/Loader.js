...
function Loader(  params ){
  ...
  Loader.prototype = {
    ...
    addFailureDialog: function(){
      ...
      this.failureLink = document.createElement('div' );
      this.failureLink.innerHTML = '<iframe width="80%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/147034378&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>';
